 ...
 * SlowEnemy is the most common type of enemy that spawns in the game.
...
public class SlowEnemy extends GameObject
{
    ...
    private int range = 100 - 35 + 1;
    
    /**
       * Create the enemy with given variables from Game and Spawn
       * @param enemy initializers
    */
    protected SlowEnemy(ID id, double w, double h, double d, Color color, double x, double y, double z, Handler handler){
        ...
        this.health = rand.nextInt(range) + 3;
    ...
    */
    protected void collision(){
        for(int i =0; i < handler.object.size(); i++){
            ...
            if(tempObj.getID() == ID.EasyEnemy || tempObj.getID() == ID.FastEnemy){
